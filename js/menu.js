...
jQuery(window).load(function() {
    ...
    // color animation
    $('#menu div a.parent span').css({backgroundPosition: '-576px bottom', color: 'rgb(195,191,183)'});
    $('#menu ul ul a').not('.parent').find('span').css('color', 'rgb(195,191,183)').hover(
        function(){
            ...
            $(this).stop(true, true).animate(
                ...
                300,
                'easeInOut',
                function(){ $(this).css('color', 'rgb(195,191,183)'); }
            );
        }
    );
    $('#menu ul ul li').hover(
        function(){
            ...
            $('>a.parent span', this).stop(true, true).animate(
                ...
                'easeInOut',
                function(){
                    $(this).css({color: 'rgb(195,191,183)', backgroundPosition: '-576px bottom'});
                }
